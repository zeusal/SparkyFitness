...
*   **`sparkyfitness-mcp`**:
    ...
    *   **Purpose**: The Model Context Protocol (MCP) server. Enable this if you want to connect AI assistants (like Claude Desktop or Cursor) to your health data for advanced pattern detection, automated coaching, and custom insights.
    *   **Ports**: Exposes port `3001` (by default) for the AI client to connect via HTTP.
