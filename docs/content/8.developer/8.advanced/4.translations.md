...
SparkyFitness is translated through [Weblate](https://hosted.weblate.org/engage/sparkyfitness). Contributors who write code touch only the English files; every other language is owned by translators and reaches the apps automatically.
...
1. Ask on [Weblate](https://hosted.weblate.org/engage/sparkyfitness) for the language to be added. Translation can start immediately and stay incomplete for as long as it needs — missing strings fall back to English, and a partially translated widget falls back to the English resource.
