...
::alert{type="info"}
For the contributor workflow — which files you may edit, how Weblate fits in, and how a language gets added — see [Translations](/developer/advanced/translations). **Only the English (`en`) files may be edited by hand.**
::
...
See [Translations](/developer/advanced/translations) for the full workflow, including the mobile app.
